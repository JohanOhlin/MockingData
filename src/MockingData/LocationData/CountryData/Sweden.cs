            ...
            States = new List<State>
            {
                new State { Code = "K", Name = "Blekinge län", AreaSquareKilometers = 2931, Population = 156590, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Karlskrona",PhoneAreaCode  = "455", PostalCode = "371 [99]", Population = 35212, IsStateCapital = true, Streets = InitiateStreets("Parkgatan","Ronnebygatan","Stenbergsgränd") },
                ...
                new State { Code = "W", Name = "Dalarnas län", AreaSquareKilometers = 28030, Population = 281359, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Falun", PhoneAreaCode  = "23", PostalCode = "791 [99]", Population = 37291, IsStateCapital = true, Streets = InitiateStreets("Svärdsjögatan","Sturegatan","Mormorsgatan")  },
                        new City { Name = "Borlänge", PhoneAreaCode  = "243", PostalCode = "781 [99]", Population = 41734, Streets = InitiateStreets("Wallingatan","Vattugatan","Bygatan") },
                ...
                new State { Code = "I", Name = "Gotlands län", AreaSquareKilometers = 3134, Population = 57405, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Visby", PhoneAreaCode  = "498", PostalCode = "621 [99]", Population = 22593, IsStateCapital = true, Streets = InitiateStreets("Berggränd","Blockgränd","Artillerigatan")  },
                ...
                new State { Code = "X", Name = "Gävleborgs län", AreaSquareKilometers = 18119, Population = 282270, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Gävle", PhoneAreaCode  = "26", PostalCode = "80[9] [99]", Population = 71033, IsStateCapital = true, Streets = InitiateStreets("Hantverkargatan","Kyrkogatan","Norra Rådmansgatan")  }
                    }
                },
                new State { Code = "N", Name = "Hallands län", AreaSquareKilometers = 5427, Population = 315427, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Halmstad", PhoneAreaCode  = "35", PostalCode = "301 [99]", Population = 58577, IsStateCapital = true, Streets = InitiateStreets("Stenvinkelsgatan","Backhausgatan","Hvitfeldtsgatan")},
                ...
                new State { Code = "F", Name = "Jönköpings län", AreaSquareKilometers = 10495, Population = 337013, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Jönköping", PhoneAreaCode  = "36", PostalCode = "551 [99]", Population = 89396, IsStateCapital = true, Streets = InitiateStreets("Myntgatan","Oxtorgsgatan","Gjuterigatan")  }
                    }
                },
                new State { Code = "Z", Name = "Jämtlands län", AreaSquareKilometers = 48945, Population = 127654, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Östersund", PhoneAreaCode  = "63", PostalCode = "831 [99]", Population = 44327, IsStateCapital = true, Streets = InitiateStreets("Postgränd","Biblioteksgatan","Tullgatan")  }
                    }
                },
                new State { Code = "H", Name = "Kalmar län", AreaSquareKilometers = 11166, Population = 238105, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Kalmar", PhoneAreaCode  = "480", PostalCode = "39[9] [99]", Population = 36392, IsStateCapital = true, Streets = InitiateStreets("Unionsgatan","Nygatan","Trädgårdsgatan")  },
                ...
                new State { Code = "G", Name = "Kronobergs län", AreaSquareKilometers = 8425, Population = 191935, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Växjö", PhoneAreaCode  = "470", PostalCode = "35[9] [99]", Population = 60887, IsStateCapital = true, Streets = InitiateStreets("Norrgatan","Kungsgatan","Klostergatan")  }
                    }
                },
                new State { Code = "BD", Name = "Norrbottens län", AreaSquareKilometers = 97257, Population = 249800, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Luleå", PhoneAreaCode  = "920", PostalCode = "971 [99]", Population = 75966, IsStateCapital = true, Streets = InitiateStreets("Köpmangatan","Stationsgatan","Sandviksgatan")  }
                    }
                },
                new State { Code = "M", Name = "Skåne län", AreaSquareKilometers = 10969, Population = 1306951, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Malmö", PhoneAreaCode  = "40", PostalCode = "21[9] [99]", Population = 280415, IsStateCapital = true, Streets = InitiateStreets("Baltzarsgatan","Stadt Hamburgsgatan","Adelgatan")  },
                        new City { Name = "Lund", PhoneAreaCode  = "46", PostalCode = "222 [99]", Population = 82800, Streets = InitiateStreets("Klostergatan","Winstrupsgatan","Sankt Petri kyrkogata") },
                        new City { Name = "Helsingborg", PhoneAreaCode  = "42", PostalCode = "25[9] [99]", Population = 97122, Streets = InitiateStreets("Möllegränden","Karlsgatan","Prästgatan") }
                    }
                },
                new State { Code = "AB", Name = "Stockholms län", AreaSquareKilometers = 6526, Population = 2239217, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Stockholm", PhoneAreaCode  = "8", PostalCode = "1[99] [99]", Population = 1372565, IsStateCapital = true, IsCountryCapital = true, Streets = InitiateStreets("Skräddargränd","Brännkyrkagatan","Högbergsgatan","Mäster Samuelsgatan","Apelbergsgatan","Kammakargatan","Luntmakargatan","Holländargatan","Regeringsgatan","Lästmakargatan","Östermalmsgatan","Floragatan","Brahegatan","Grev Turegatan","Armfeltsgatan","Sandelsgatan","Olaus Petrigatan","Kampementsgatan","Dalagatan")}
                    }
                },
                new State { Code = "D", Name = "Södemanlands län", AreaSquareKilometers = 6076, Population = 284470, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Nyköping", PhoneAreaCode  = "155", PostalCode = "611 [99]", Population = 29891, IsStateCapital = true, Streets = InitiateStreets("Östra Storgatan","Folkungavägen","Västra Kvarngatan")  }
                    }
                },
                new State { Code = "C", Name = "Uppsala län", AreaSquareKilometers = 8192, Population = 355466, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Uppsala", PhoneAreaCode  = "18", PostalCode = "75[9] [99]", Population = 140454, IsStateCapital = true, Streets = InitiateStreets("Krusbärsgatan","Bruno Liljeforsgatan","Bangårdsgatan")  }
                    }
                },
                new State { Code = "S", Name = "Värmlands län", AreaSquareKilometers = 17517, Population = 276280, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Karlstad", PhoneAreaCode  = "54", PostalCode = "65[9] [99]", Population = 61685, IsStateCapital = true, Streets = InitiateStreets("Färjestadsvägen","Skyttegatan","Granegatan")  }
                    }
                },
                new State { Code = "AC", Name = "Västerbottens län", AreaSquareKilometers = 54672, Population = 263876, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Umeå", PhoneAreaCode  = "90", PostalCode = "900 [99]", Population = 79594, IsStateCapital = true, Streets = InitiateStreets("Skolgatan","Magasinsgatan","Sveagatan")  }
                    }
                },
                new State { Code = "Y", Name = "Västernorrlands län", AreaSquareKilometers = 21552, Population = 244034, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Härnösand", PhoneAreaCode  = "611", PostalCode = "871 [99]", Population = 17556, IsStateCapital = true, Streets = InitiateStreets("Skeppsbron","Norra Kyrkogatan","Hovsgatan")  }
                    }
                },
                new State { Code = "U", Name = "Västmanlands län", AreaSquareKilometers = 5118, Population = 264796, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Västerås", PhoneAreaCode  = "21", PostalCode = "721 [99]", Population = 110877, IsStateCapital = true, Streets = InitiateStreets("Brahegatan","Vallingatan","Kassörgatan")  }
                    }
                },
                new State { Code = "O", Name = "Västra Götalands län", AreaSquareKilometers = 23797, Population = 1652641, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Göteborg", PhoneAreaCode  = "31", PostalCode = "40[9] [99]", Population = 549839, IsStateCapital = true, Streets = InitiateStreets("Vallgatan","Södra Larmgatan","Basargatan","Karl Gustavsgatan","Erik Dahlbergsgatan","Götabergsgatan","Haga Östergata","Frigångsgatan","Fjärde Långgatan","Drottninggatan")  }
                    }
                },
                new State { Code = "T", Name = "Örebro län", AreaSquareKilometers = 8504, Population = 291617, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Örebro", PhoneAreaCode  = "19", PostalCode = "701 [99]", Population = 107038, IsStateCapital = true, Streets = InitiateStreets("Olaigatan","Manillagatan","Engelbrektsgatan")  }
                    }
                },
                new State { Code = "E", Name = "Östergötlands län", AreaSquareKilometers = 10545, Population = 446663, Country = this,
                    Cities = new List<City>{
                        new City { Name = "Linköping", PhoneAreaCode  = "13", PostalCode = "58[9] [99]", Population = 104232, IsStateCapital = true, Streets = InitiateStreets("Kungsgatan","Badhusgatan","Sankt Larsgatan")  },
                        new City { Name = "Norrköping", PhoneAreaCode  = "11", PostalCode = "60[9] [99]", Population = 87247, Streets = InitiateStreets("Repslagaregatan","Hospitalsgatan","Sundeliusgatan") }
                    }
                }
